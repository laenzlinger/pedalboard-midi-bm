...
pub fn handle(rc500: &mut RC500, control: Control, value: Value7) -> Vec<MidiMessage, 8> {
    match control {
        ...
        XTONE_RED_A => rc500.midi_messages(RC500Event::RhythmPattern(Direction::Up)),
        XTONE_RED_B => rc500.midi_messages(RC500Event::DrumkitsDown()),
        XTONE_RED_C => NONE,
        XTONE_RED_D => rc500.midi_messages(RC500Event::RhythmPattern(Direction::Down)),
        XTONE_RED_E => rc500.midi_messages(RC500Event::DrumkitsUp()),
        XTONE_RED_F => NONE,
